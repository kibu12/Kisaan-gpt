...
def detect_intent(query: str) -> str:
    ...
    - 'crop' : soil parameter based crop recommendation
    """
...
class OrchestratorAgent:
    ...
    def _synthesize_rag_only(self, query: str, context: str, language: str) -> str:
        ...
        prompt = f"""You are KISAAN-GPT, an agricultural advisor.
{lang}
Answer this question using ONLY the provided context. Cite the source.
